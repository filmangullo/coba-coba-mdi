...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Board Members Language Lines
    |--------------------------------------------------------------------------
    |
    | The following language lines are used by the paginator library to build
    | the simple Board Members links. You are free to change them to anything
    | you want to Board Members size your views to better match your application.
    |
    */
    ...
    'about_chin_kien_ping'          => '
        <span class="ml-12">A Malaysian</span> citizen, 44 years old domiciled in Kuala Lumpur, appointed as the President Commissioner based on shareholder’s decision on March 22, 2017, in accordance with Notarial Deed Number 132 dated March 22, 2017. <br><br>
    ...
    'about_sutiyoso_bin_risman'     => '
        <span class="ml-12">An</span> Indonesian citizen, aged 50 years domiciled in Medan, appointed as a Director of the Company based on shareholder decisions on March 22, 2017, in accordance with Notarial Deed Number 132 dated March 22, 2017. He has worked in the Company since 2002 with a position as General Manager between 2002 – 2009, before being appointed as Commissioner until 2014.
    ',
    'independent_director'          => 'Independent Director',
    'about_cahaya_dewi_surbakti'    => '
        <span class="ml-12">An</span> Indonesian citizen, 38 years old, domiciled in Medan, appointed as the Independent Director of the Company on 30 April 2018, based on the decision of the shareholders at the Annual General Meeting of Shareholders, in accordance with Notarial Deed Number 39 dated 30 April 2018.<br><br>
