        ...
        <div class="max-w-md px-4 mx-auto text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
            ...
            <div class="mt-12">
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    @foreach ($y->financialReports as $a)
                    ...
                    <div class="pt-6">
                        <div class="flow-root px-6 pb-8 rounded-lg shadow-md bg-gray-50">
                            <div class="-mt-6">
                                ...
                                <p class="mt-2 text-center font-1xs">{{ $a->title_id }}</p>
                                <hr>
                                <p class="mt-2 text-center font-1xs">{{ $a->title_cn }}</p>
                                <hr>
                                <p class="mt-2 font-semibold text-center font-1xs">{{ date('F, Y', strtotime($a->month)) }}</p>
                            </div>
                            <button wire:click="openDeleteFrModal({{$a->id}})" type="button"
            ...
            <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div
                    ...
                    <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                        <button wire:click='deleteFr' type="button"
                            class="inline-flex justify-center w-full px-4 py-2 text-base font-medium text-white bg-red-600 border border-transparent rounded-md shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm">
                            Delete
                        </button>
                        <button wire:click='closeDeleteFrModal' type="button"
