<div class="">
    ...
    <div class="border-b border-gray-500 ">
        ...
        <div class="flex flex-wrap items-start w-full mx-auto -my-3 lg:container lg:mx-auto py-14 xsm:px-4 lg:flex-nowrap sm:px-6 lg:px-8 ">
        @foreach($product as $item)
        <div wire:click="preview('{{$item->img}}')"
