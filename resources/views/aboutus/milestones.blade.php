...
@section('content')
    <div class="w-full h-auto relative pt-12 lg:pt-24">
        ...
        <div class="absolute text-white text-center w-full text-sm sm:text-2xl lg:text-4xl font-bold top-1/2 mt-5 h-full">Milestones</div>
    </div>
    <div class="my-12 lg:my-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="w-full h-auto relative grid grid-cols-1 justify-center">
            ...
            <div class="grid grid-cols-12 mb-12 z-10 justify-center">
                ...
                <div class="col-span-10 sm:col-span-5 text-left sm:space-y-1 lg:space-y-2 ml-3 md:-ml-3 lg:-ml-6 xl:-ml-12">
                    <div class="text-mark-default text-2xl lg:text-3xl font-bold">2002</div>
                    <div class="text-xs lg:text-sm">Establishment of PT Mark Dynamics Indonesia</div>
                </div>
            </div>

            <div class="grid grid-cols-12 mb-12 z-10 justify-center">
                <div class="col-span-5 hidden sm:block text-right sm:space-y-1 lg:space-y-2 mr-3 md:-mr-3 lg:-mr-6 xl:-mr-12">
                    <div class="text-mark-default text-2xl lg:text-3xl font-bold">2003</div>
                    <div class="text-xs lg:text-sm">Built the first factory on an area of 3.000 m2 armed with a 50.000 pieces per month capacity.</div>
                </div>
                <div class="col-span-2">
                    <img class="mx-auto" src="{{ asset('img/settings-icon.png') }}" alt="Mark Dynamics Milestones">
                </div>
                <div class="col-span-5 sm:block hidden"></div>
                <div class="col-span-10 sm:hidden text-left sm:space-y-1 lg:space-y-2 ml-3">
                    <div class="text-mark-default text-2xl lg:text-3xl font-bold">2003</div>
                    <div class="text-xs lg:text-sm">Built the first factory on an area of 3.000 m2 armed with a 50.000 pieces per month capacity.</div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-12 mb-12 z-10 justify-center">
                ...
                <div class="col-span-10 sm:col-span-5 text-left sm:space-y-1 lg:space-y-2 ml-3 md:-ml-3 lg:-ml-6 xl:-ml-12">
                    ...
                    <div class="text-xs lg:text-sm">Acquired a 3.500 m2 land and additional capacity of 5.000 pieces per month.</div>
                </div>
            </div>
