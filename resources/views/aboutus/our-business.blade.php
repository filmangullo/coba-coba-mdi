...
@section('content')
    <div class="w-full h-auto relative pt-12 lg:pt-24">
        ...
        <div class="absolute text-white text-center w-full text-sm sm:text-2xl lg:text-4xl font-bold top-1/2 mt-5 h-full">Our Business</div>
    </div>
    <div class="max-w-7xl mx-auto lg:grid grid-cols-2 px-4 gap-7 sm:px-6 lg:px-8 my-12 lg:my-24">
        <div>
            <img class="w-full h-48 sm:h-96 lg:h-full object-cover rounded-md" src="{{ asset('img/our-business-pic.png') }}" alt="Mark Dynamics Indonesia">
        </div>
        <div>
            <div class="text-xl mt-12 lg:mt-0 lg:text-2xl mb-6 lg:mb-12 font-bold">PT. Mark Dynamics Indonesia Tbk</div>
            <div class="text-xs lg:text-sm">PT Mark Dynamics Indonesia (the Company) is a global leading manufacturer of hand former in Indonesia. Established on 10 April 2002, we are currently based in North Sumatera, Indonesia. Our products are essential to making latex gloves for various purposes: examination, industrial, medical, household, and even custom-made.
                We set out on our long journey by producing merely 50,000 pieces per month back in 2003.<br><br> Gradually, we have been increasing our production capacity, and we have currently reached 1,400,000 pieces per month. The main plant site is located in Medan STAR Industrial Estate, North Sumatera with land area of ±15,000 meter square, with current production capacity standing at 600,000 pieces per month.
                Meanwhile, the second plant, commencing operation in 2019, is located in Tanjung Morawa, North Sumatera with land area of ±90,000 meter square. It closed the year 2019 with a capacity of 100,000 pieces per month. By year-end 2020, it had reached a capacity of 550,000 pieces per month. Combined with the main factory, we had an average capacity of 800,000 pieces per month along the year 2020.<br><br> We started the year 2021 by increasing our total capacity to 1,100,000 pieces per month, and it’s targeted the number will hit 1,800,000 by year-end 2021. Thus, our average output from both plants is estimated to reach 1,400,000 pieces per month this year.
                In 2020, we decided to tap into sanitary products. Our closets are partially made of the waste coming from Porcelain Hand Former production in order to reduce costs. The Indonesian Government’s program of building 1 million houses is a positive driver to our sales as our closets are meant to penetrate the middle-low market segment.<br><br> In October 2020, we acquired PT. Berjaya Dynamics Indonesia, a distributor of agricultural products such as sprayer, pesticides, etc. 
