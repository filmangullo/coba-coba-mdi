...
<div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 gap-4 px-12 mb-24 md:grid-flow-col md:grid-cols-3">
        ...
        <div class="col-span-2">
            ...
            <div class="col-span-1 text-justify md:col-span-4 md:row-span-2 md:ml-5">
                <span class="ml-12">An</span> Indonesian citizen, aged 50 years domiciled in Medan, appointed as a Director of the Company based on shareholder decisions on March 22, 2017, in accordance with Notarial Deed Number 132 dated March 22, 2017.
