...
<div class="w-full h-auto relative pt-24">
    ...
    <div class="absolute text-white text-center w-full text-3xl sm:text-4xl font-bold top-1/2 mt-5 h-full">Public Expose</div>
</div>
...
<div class="space-y-24 py-24">
        ...
        @php $data = ['Pubex MARK 2020', 'Pubex QnA MARK 2020']; @endphp
