...
<div class="my-24 w-full mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-start  items-start md:flex-nowrap flex-wrap -mx-4 -my-6">
    ...
    @foreach($data as $key => $val)
        <div class="space-y-6 w-6/12 md:w-3/12 px-4 py-6">
            ...
            <div class="text-base md:text-lg cursor-pointer font-bold text-center">Annual Report MARK 201{{$i--}}</div>
        </div>
    @endforeach
    </div>
</div>
